...
export interface Reward {
	...
	item: $ItemStack;
	/**
	 * The chance of this item being rewarded. The number is the amount of times the item is added to the loot table.
	 * For example, if the chance is 100, the item will be added 100 times to the loot table.
	 */
	chance: number;
}
...
export function getDefaultRewards(): Reward[] {
	return [
		...
		{ item: Item.of("alltheores:steel_ingot", 5), chance: 500 },
		{ item: Item.of("mekanism:ingot_refined_glowstone", 3), chance: 500 },
		{ item: Item.of("mekanism:ingot_refined_obsidian", 3), chance: 500 },
		{ item: Item.of("alltheores:osmium_ingot", 3), chance: 500 },
		{ item: Item.of("alltheores:tin_ingot", 3), chance: 500 },
		{ item: Item.of("alltheores:lead_ingot", 3), chance: 500 },
		...
		{ item: Item.of("alltheores:zinc_ingot", 3), chance: 500 },
